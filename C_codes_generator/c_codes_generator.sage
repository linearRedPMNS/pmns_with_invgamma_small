...
def choose_target_archi_info(phi_log2):
	if phi_log2 == 8:
		...
		print("ERROR: unspecified info for this architecture. No code has been generated.")
	return -1
...
def build_pmns_c_codes(pmns_data, p_num=0, pmns_num=0):
	...
	(rho, rho_nbits) = compute_rho_rhoLog2(t, E_alpha, E_lambda)
	...
	double_sparse = is_DoubleSparse(t, phi_log2)
	...
	build_data_file(dir_path, F, p, n, phi_log2, rho_nbits, delta, big_int_name, big_int, small_int, convbase_log2, ext_pol, red_int_mat, neginv_red_int_mat, R, iM_dom)
	...
	build_useful_functs_c_file(dir_path, small_int, big_int, p, gmm)
